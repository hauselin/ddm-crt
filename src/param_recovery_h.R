...
write_rds(fit, "../data/simulated_data_normal_recovery_h.rds")
#%%
...
p15 <- (p11 + p12) / (p13 + p14)
p15
ggsave("../figures/parameter_recovery_normal_h.png", p15, dpi = 300, width = 13, height = 13, bg = 'white')
...
p105
ggsave("../figures/parameter_recovery_normal_h_simulate-crt.png", p105, dpi = 300, width = 13, height = 13, bg = 'white')
#%%
